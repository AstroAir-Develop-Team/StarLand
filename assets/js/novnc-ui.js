...
import * as Log from '../js/novnc/util/logging.js';
import _, { l10n } from './novnc-localization.js';
import { isTouchDevice, isSafari, hasScrollbarGutter, dragThreshold }
    from '../js/novnc/util/browser.js';
import { setCapture, getPointerEvent } from '../js/novnc/util/events.js';
import KeyTable from "../js/novnc/input/keysym.js";
import keysyms from "../js/novnc/input/keysymdef.js";
import Keyboard from "../js/novnc/input/keyboard.js";
import RFB from "../js/novnc/rfb.js";
import * as WebUtil from "./novnc-webutil.js";
 ...
 * ------v------*/
    ...
    openGPSPanel: function() {
        UI.closeAllPanels();
        UI.openControlbar();

        document.getElementById('gps_controls')
            .classList.add("noVNC_open");
        document.getElementById('gps_controls_button')
            .classList.add("noVNC_selected");
    },

    closeGPSPanel: function() {
        document.getElementById('gps_controls')
            .classList.remove("noVNC_open");
        document.getElementById('gps_controls_button')
            .classList.remove("noVNC_selected");
    ...
    toggleGPSPanel: function() {
        if (document.getElementById('gps_controls')
            .classList.contains("noVNC_open")) {
            UI.closeGPSPanel();
        } else {
            UI.openGPSPanel();
...
* ------v------*/
    ...
    openWebmanagerPanel: function() {
        UI.closeAllPanels();
        UI.openControlbar();

        document.getElementById('indi_webmanager_controls')
            .classList.add("noVNC_open");
        document.getElementById('indi_webmanager_controls_button')
            .classList.add("noVNC_selected");
    },

    closeWebmanagerPanel: function() {
        document.getElementById('indi_webmanager_controls')
            .classList.remove("noVNC_open");
        document.getElementById('indi_webmanager_controls_button')
            .classList.remove("noVNC_selected");
    ...
    toggleWebmanagerPanel: function() {
        if (document.getElementById('indi_webmanager_controls')
            .classList.contains("noVNC_open")) {
...
if (l10n.language === "en" || l10n.dictionary !== undefined) {
    ...
    fetch('../../assets/locale/novnc/' + l10n.language + '.json')
        .then((response) => {
            if (!response.ok) {
                throw Error("" + response.status + " " + response.statusText);
            }
